 ...
 var width = allConfig().sizingWidth;
 var height = allConfig().sizingHeight;
 ...
 function addCSS() {
     ...
     var css = document.createTextNode(
         ...
         ".swFunctionalPopup{display: block; position: fixed; width: " + width + "px; height: " + height + "px; z-index: 10002;" +
         ...
         ".swImg{width:" + width + "px; height: " + height + "px;}" +
         ".swCloseEl{position: absolute;display:inline-block;width: " + height / 50 + "%;height:" + width / 50 + "%; top: 2%;right: 4%;cursor: pointer; border-radius: 50%;}" +
         this.css
     );
