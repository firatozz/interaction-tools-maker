...
function elementConstructor() {
    ...
    bgEl.className = "itmBgEl";
    document.body.appendChild(bgEl);

    //Add the popup

    if (document.querySelector(".itmPopupEl")) {
        popupEl = document.querySelector(".itmPopupEl");
        ...
        popupEl.innerHTML = "<a href=//" + targetUrl + " target='" + x + "'><img class='swImg' src='" + imageUrl + "'></a>";
        document.body.appendChild(popupEl);
    }

    //Add close button
    if (document.querySelector(".swCloseEl")) {
        closeBtnEl = document.querySelector(".swCloseEl");
    } else {
        closeBtnEl = document.createElement("img");
        closeBtnEl.className = "swCloseEl";
